public class ASTVariableDefStatement extends ASTStatement
{
	...
	public ASTVariableDefStatement(String type, String name,
			ASTExpression init, int line)
	{
		type_ = type;
		name_ = name;
		arraydimension_ = 0;
	...
	public ASTVariableDefStatement(String type, String name,
			int arraydimension, ASTExpression init, int line)
	{
		type_ = type;
		name_ = name;
		arraydimension_ = arraydimension;
