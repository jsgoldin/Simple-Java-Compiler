...
public class simplejava implements simplejavaConstants {
  ...
  static final public ASTProgram program() throws ParseException {ASTProgram aP = new ASTProgram(null, null, 0);
...
// this should return ASTClasses
  static final public ASTClasses classDefs() throws ParseException {ASTClasses classes = new ASTClasses();
    ASTClass astClass;
    label_1:
    while (true) {
...
{if ("" != null) return classes;}
  ...
  static final public ASTFunctionDefinitions funcDecs() throws ParseException {ASTFunctionDefinitions functionDefs = new ASTFunctionDefinitions();
...
/* All Functions have been parsed */
        {if ("" != null) return functionDefs;}
    throw new Error("Missing return statement in function");
  }

  static final public ASTClass classDef() throws ParseException {ASTClass astClass;
...
astClass = new ASTClass(name.toString(), variableDefs, name.beginLine);
  ...
  static final public ASTFunctionDefinition funcDec() throws ParseException {Token type, name;
    ASTFormals formals;
...
/* Function Prototype STATUS: DONE */
            {if ("" != null) return new ASTPrototype(type.toString(),  name.toString(), formals, type.beginLine);}
      break;
      }
    case LEFTBRACE:{
      jj_consume_token(LEFTBRACE);
...
/* Function Definition STATUS: NOTDONE */
            {if ("" != null) return new ASTFunction(type.toString(),  name.toString(), formals, statements, type.beginLine);}
      break;
      }
    default:
      jj_la1[4] = jj_gen;
  ...
  static final public ASTFormals formalParamList() throws ParseException {ASTFormals formals = new ASTFormals(); ASTFormal formal; Token type, name; int dimCount;
...
{if ("" != null) return formals;}
  ...
  static final public int arrayDimDec() throws ParseException {int dimCount = 0;
    label_7:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case LEFTBRACKET:{
...
{if ("" != null) return dimCount;}
    throw new Error("Missing return statement in function");
  }

  static final public ASTInstanceVariableDef classVariableDef() throws ParseException {ASTInstanceVariableDef instanceVar;
    Token type, name;
    int arrayDim;
    type = jj_consume_token(IDENTIFIER);
    name = jj_consume_token(IDENTIFIER);
...
instanceVar = new ASTInstanceVariableDef(type.toString(), name.toString(), arrayDim, type.beginLine);
        {if ("" != null) return instanceVar;}
    throw new Error("Missing return statement in function");
  }

  static final public ASTStatement statement() throws ParseException {ASTStatement resultingStatement = null;
    Token lineToken;
    boolean flag = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LEFTBRACE:{
...
{if ("" != null) return resultingStatement;}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  static final public ASTVariable propertyAccessors(ASTVariable base) throws ParseException {ASTExpression indexExp;
    Token member;
...
if(returnVar == null) {
                    {if ("" != null) return childArrayVar;}
                } else {
                    {if ("" != null) return returnVar;}
                }
      break;
      }
    case DOT:{
...
if(returnVar == null) {
  ...
  static final public ASTStatement identifierPrefix() throws ParseException {Token type, name;
...
/* An assignment statement was parsed */
                        {if ("" != null) return new ASTAssignmentStatement(baseVar,exp,type.beginLine);}
        break;
        }
      case PLUS:
      case MINUS:{
...
/* Variable declaration statement */
            ...
            {if ("" != null) return varDefStatement;}
      break;
      }
    case LEFTPARAN:{
      jj_consume_token(LEFTPARAN);
...
funcCallStatement.addElement(exp);
      ...
      jj_consume_token(RIGHTPARAN);
{if ("" != null) return funcCallStatement;}
      break;
      }
    default:
      jj_la1[21] = jj_gen;
...
{if ("" != null) return null;}
  ...
  static final public ASTAssignmentStatement incrementShortSuffix(ASTVariable base) throws ParseException {ASTAssignmentStatement assignmentStatement;
...
one = new ASTIntegerLiteral(1, lineStart.beginLine);
  ...
  static final public ASTStatement blockStatement() throws ParseException {ASTStatements statements = new ASTStatements();
...
{if ("" != null) return statements;}
  ...
  static final public ASTExpression arrayDimWithExpression() throws ParseException {ASTExpression elem = null;    // the expression inside of the brackets
...
// XXX: Dangling else warning!
  static final public ASTIfStatement ifStatement() throws ParseException {ASTExpression test;
...
{if ("" != null) return new ASTIfStatement(test, thenstatement, elsestatement, ifToken.beginLine);}
    throw new Error("Missing return statement in function");
  }

  static final public ASTStatement whileStatement() throws ParseException {ASTExpression test;
    ASTStatement body;
    Token tokenLine;
    ...
    jj_consume_token(RIGHTPARAN);
    body = statement();
{if ("" != null) return new ASTWhileStatement(test, body, tokenLine.beginLine);}
    throw new Error("Missing return statement in function");
  }

  static final public ASTStatement forStatement() throws ParseException {ASTStatement initialize = null;
    ...
    jj_consume_token(RIGHTPARAN);
    body = statement();
{if ("" != null) return new ASTForStatement(initialize, test, increment, body, lineToken.beginLine);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ASTDoWhileStatement doWhileStatement() throws ParseException {ASTExpression test = null;
    ...
    test = expression();
    jj_consume_token(RIGHTPARAN);
{if ("" != null) return new ASTDoWhileStatement(test, body, tokenLine.beginLine);}
    throw new Error("Missing return statement in function");
  }

  static final public ASTReturnStatement returnStatement() throws ParseException {ASTExpression exp = null;
...
{if ("" != null) return new ASTReturnStatement(exp, lineToken.beginLine);}
    throw new Error("Missing return statement in function");
  }

  static final public ASTExpression expression() throws ParseException {Token type;
...
/* Allocating an array */
                    {if ("" != null) return new ASTNewArrayExpression(type.toString(), resultingExpression, arrayDimCount, type.beginLine);}
        break;
        }
      case LEFTPARAN:{
        informalParamList();
/* Instantiating class */
                     {if ("" != null) return new ASTNewClassExpression(type.toString(), type.beginLine);}
        break;
        }
      default:
        jj_la1[30] = jj_gen;
...
{if ("" != null) return resultingExpression;}
      break;
      }
    default:
      jj_la1[31] = jj_gen;
...
/* All expresions that do not start with the <NEW> */
  static final public ASTExpression expNoNew() throws ParseException {ASTExpression resultingExpression = null;
...
{if ("" != null) return null;}
  ...
  static final public ASTExpression expressionTopTopCHILL() throws ParseException {ASTExpression left = null;
...
{if ("" != null) return left;}
  ...
  static final public ASTExpression expressionTopCHILL() throws ParseException {ASTExpression left = null;
    ASTExpression right = null;
...
{if ("" != null) return left;}
  ...
  static final public ASTExpression expressionCHILL() throws ParseException {ASTExpression left = null;
    ASTExpression right = null;
...
{if ("" != null) return left;}
  ...
  static final public ASTExpression termCHILL() throws ParseException {ASTExpression left = null;
    ASTExpression right = null;
    Token operatorToken = null;
    Token notToken = null;
...
{if ("" != null) return left;}
  ...
  static final public ASTExpression factor() throws ParseException {ASTExpression exp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LEFTPARAN:{
      jj_consume_token(LEFTPARAN);
...
{if ("" != null) return exp;}
  ...
  static final public ASTExpression expNoNewNoParans() throws ParseException {ASTExpression left;
    ASTExpression right = null;
    Token operator = null;
...
if(right==null) {
            ...
            {if ("" != null) return new ASTOperatorExpression(left, right, operator.toString(), operator.beginLine);}
        }
    throw new Error("Missing return statement in function");
  }

  static final public ASTExpression expressionVarOrConstant() throws ParseException {ASTExpression resultingExpression;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
...
{if ("" != null) return resultingExpression;}
  ...
  static final public ASTExpression expressionVar() throws ParseException {Token base;
    ASTVariable baseVar;
...
if(functionCall != null) {
            ...
            {if ("" != null) return new ASTVariableExpression(baseVar, base.beginLine);}
        }
    throw new Error("Missing return statement in function");
  }

  static final public void classExpVar() throws ParseException {Token classVar;
    jj_consume_token(DOT);
    classVar = jj_consume_token(IDENTIFIER);
  }

/* Parses primitives */
  static final public ASTExpression expressionConstant() throws ParseException {Token boolVal;
...
if (charVal.toString().length() > 0) {
            {if ("" != null) return new ASTCharLiteral(charVal.toString().charAt(0), charVal.beginLine);}
        } else {
            {if ("" != null) return new ASTCharLiteral('\u005c0', charVal.beginLine);}
        }
      break;
      }
    case TRUE:
...
/* Boolean Literal was parsed. */
        ...
        {if ("" != null) return new ASTBooleanLiteral(actualValue, boolVal.beginLine);}
      break;
      }
    case MINUS:
    case INTEGER_LITERAL:{
...
int actualIntValue = Integer.parseInt(intLiteral.toString());
        if(isNegative) {
            {if ("" != null) return new ASTOperatorExpression( new ASTIntegerLiteral(0, intLiteral.beginLine), new ASTIntegerLiteral(actualIntValue, intLiteral.beginLine), "-", intLiteral.beginLine);}
        }
        {if ("" != null) return new ASTIntegerLiteral(actualIntValue, intLiteral.beginLine);}
      break;
      }
    default:
      jj_la1[51] = jj_gen;
  ...
  static final public ASTFunctionCallExpression expInformalParamList(Token base) throws ParseException {ASTExpression formal = null;
...
{if ("" != null) return functionCall;}
  ...
  static final public Token expressionOperator() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS:{
