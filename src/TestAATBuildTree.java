...
class TestAATBuildTree
{
	...
	public static void main(String args[])
	{
		...
		AATExpression test = bt.constantExpression(1);
		AATStatement ifbody = bt.emptyStatement();
		AATStatement elsebody = bt.emptyStatement();
		;

		AATStatement ifStatement = bt.ifStatement(test, ifbody, elsebody);
		ifStatement.Accept(pt);
		 ...
		 * bt.constantExpression(15); exptree.Accept(pt);
		 * System.out.println("--------------------------");
		 * System.out.println("Testing expression : 4 + 5 ");
		 * System.out.println("--------------------------"); exptree =
		 * bt.operatorExpression
		 * (bt.constantExpression(4),bt.constantExpression(5),
		 * AATOperator.PLUS); System.out.println(exptree); exptree.Accept(pt);
		 * System.out.println("================= ");
		 ...
		 * System.out.println("-------------------------------"); exptree =
		 * bt.baseVariable(4); exptree.Accept(pt);
		 * System.out.println("----------------------------------------");
		 * System.out.println("Assingment:  x := 3 (x local, offset = 4)");
		 * System.out.println("----------------------------------------");
		 * stmtree = bt.assignmentStatement(bt.baseVariable(4),
		 * bt.constantExpression(3)); stmtree.Accept(pt); System.out.println(
		 * "-----------------------------------------------------------");
		 * System.out.println(
		 * "For: for(i=0; i < 10; i++) x := 0;   x offset 4, i offset 8 ");
		 * System.out.println(
		 * "------------------------------------------------------------");
		 ...
		 * bt.operatorExpression(bt.baseVariable(8), bt.constantExpression(1),
		 * AATOperator.PLUS)), bt.assignmentStatement(bt.baseVariable(4),
		 * bt.constantExpression(0))); stmtree.Accept(pt);
		 */
