public class ASTUnaryOperatorExpression extends ASTExpression
{
	...
	public ASTUnaryOperatorExpression(ASTExpression operand, int operator,
			int line)
	{
		operator_ = operator;
		operand_ = operand;
		line_ = line;
		System.out.println("Line_ is " + line_);
	}

	public ASTUnaryOperatorExpression(ASTExpression operand, String operator,
			int line)
	{
		operand_ = operand;
		line_ = line;
